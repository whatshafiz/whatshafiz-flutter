  ...
  static ThemeData get lightTheme {
    return ThemeData(
        ...
        appBarTheme: AppBarTheme(
            ...
            backgroundColor: ApplicationConstants.APP_COLOR,
            titleTextStyle: TextStyle(
                color: AppColor.Black, fontSize: 16, fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w800),
            systemOverlayStyle: SystemUiOverlayStyle.dark.copyWith(statusBarColor: AppColor.White)),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
        ...
        appBarTheme: AppBarTheme(
            ...
            titleTextStyle: TextStyle(
                color: AppColor.White, fontSize: 16, fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w800),
